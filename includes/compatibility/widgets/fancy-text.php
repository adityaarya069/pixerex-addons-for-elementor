...
namespace PixerexAddons\Compatibility\WPML\Widgets;
...
class FancyText extends WPML_Elementor_Module_With_Items {
	...
	public function get_items_field() {
		return 'pixerex_fancy_text_strings';
	}
	...
	public function get_fields() {
		return array(
			'pixerex_text_strings_text_field',
		);
	}
	...
	protected function get_title( $field ) {
        ...
        return __( 'Fancy Text: String', 'pixerex-addons-for-elementor' );
