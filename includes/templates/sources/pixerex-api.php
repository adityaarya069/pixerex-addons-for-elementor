...
namespace PixerexAddons\Includes\Templates\Sources;
...
class Pixerex_Templates_Source_Api extends Pixerex_Templates_Source_Base {
	...
	*/
	public function get_version() {
		...
		if ( ! $version ) {
			$version = Templates\pixerex_templates()->api->get_info( 'api_version' );
	...
	*/
	...
	public function remote_get_templates( $tab ) {
		...
		$api_url = Templates\pixerex_templates()->api->api_url( 'templates' );
	...
	public function remote_get_categories( $tab ) {
		...
		$api_url = Templates\pixerex_templates()->api->api_url( 'categories' );
	...
	public function remote_get_keywords( $tab ) {
		...
		$api_url = Templates\pixerex_templates()->api->api_url( 'keywords' );
	...
	*/
	public function get_item( $template_id, $tab = false ) {
        ...
        $license_key = Templates\pixerex_templates()->config->get( 'key' );
        
		$api_url = Templates\pixerex_templates()->api->api_url( 'template' );
