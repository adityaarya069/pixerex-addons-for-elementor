...
abstract class Pixerex_Templates_Source_Base {
	...
	*/
	...
	public function templates_key() {
		return 'pixerex_templates_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function categories_key() {
		return 'pixerex_categories_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function keywords_key() {
		return 'pixerex_keywords_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	/**
	 * Returns template ID prefix for pixerex templates
	 *
	 * @return string
	 */
