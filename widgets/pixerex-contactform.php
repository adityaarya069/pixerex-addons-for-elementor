...
class Pixerex_Contactform extends Widget_Base {
	...
	public function get_title() {
        return sprintf( '%1$s %2$s', Helper_Functions::get_prefix(), __('Contact Form7', 'pixerex-addons-for-elementor') );
	}
    ...
    protected function _register_controls() {
  		...
  		$this->start_controls_section('pixerex_section_wpcf7_form',
  			[
  				'label' => __( 'Contact Form', 'pixerex-addons-for-elementor' )
  			]
  		);
		...
		$this->add_control('pixerex_wpcf7_form',
			[
				'label' => __( 'Select Your Contact Form', 'pixerex-addons-for-elementor' ),
				'label_block' => true,
        ...
        $this->start_controls_section('pixerex_wpcf7_fields', 
            [
                'label'     => __('Fields', 'pixerex-addons-for-elementor'),
            ]
        );
        ...
        $this->add_responsive_control('pixerex_elements_input_width',
  			[
  				'label' => __( 'Input Field', 'pixerex-addons-for-elementor' ),
         ...
         $this->add_responsive_control('pixerex_elements_textarea_width',
  			[
  				'label' => __( 'Text Area', 'pixerex-addons-for-elementor' ),
  				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', '%' ],
				'range' => [
					'px' => [
        ...
        $this->start_controls_section('section_contact_form_styles',
			[
				'label' => __( 'Form', 'pixerex-addons-for-elementor' ),
        ...
        $this->add_control('pixerex_elements_input_background',
			[
				'label'         => __( 'Input Field Background', 'pixerex-addons-for-elementor' ),
		...
		$this->add_control('pixerex_elements_input_focus',
			[
				'label' => __( 'Focus Border Color', 'pixerex-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control('pixerex_elements_input_focus_border_animation',
			[
				'label'         => __( 'Focus Border Animation', 'pixerex-addons-for-elementor' ),
        ...
        $this->add_control('pixerex_elements_input_focus_border_color',
			[
				'label'         => __( 'Focus Line Color', 'pixerex-addons-for-elementor' ),
				'type'          => Controls_Manager::COLOR,
                'condition'		=> [
        ...
        $this->add_control('pixerex_elements_heading_default',
			[
				'type' => Controls_Manager::HEADING,
				'label' => __( 'Default Typography', 'pixerex-addons-for-elementor' ),
			]
		);
		
		$this->add_control('pixerex_elements_contact_form_color',
			[
				'label' => __( 'Default Font Color', 'pixerex-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
                'scheme' => [
      ...
      $this->add_control('pixerex_elements_heading_input',
			[
				'type' => Controls_Manager::HEADING,
				'label' => __( 'Input Typography', 'pixerex-addons-for-elementor' ),
                'separator' => 'before',
			]
		);
		...
		$this->add_control('pixerex_elements_contact_form_field_color',
			[
				'label' => __( 'Input Text Color', 'pixerex-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
                'scheme' => [
					'type' => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
		...
		$this->add_control('pixerex_elements_contact_form_placeholder_color',
			[
				'label' => __( 'Placeholder Color', 'pixerex-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_tab( 'normal', [ 'label' => __( 'Normal', 'pixerex-addons-for-elementor' ) ] );
