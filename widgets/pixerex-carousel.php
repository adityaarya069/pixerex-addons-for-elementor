...
class Pixerex_Carousel extends Widget_Base {
	...
	public function get_title() {
        return sprintf( '%1$s %2$s', Helper_Functions::get_prefix(), __('Carousel', 'pixerex-addons-for-elementor') );
	}
    ...
    // Adding the controls fields for the pixerex carousel
	...
	protected function _register_controls() {
        ...
        $this->add_control('pixerex_carousel_content_type',
			[
				...
				'description'	=> __( 'How templates are selected', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SELECT,
				'options'		=> [
					'select'        => __( 'Select Field', 'pixerex-addons-for-elementor' ),
					'repeater'		=> __( 'Repeater', 'pixerex-addons-for-elementor' )
				],
                'default'		=> 'select'
			]
		);
		...
		$this->add_control('pixerex_carousel_slider_content',
		  	[
		     	'label'         => __( 'Templates', 'pixerex-addons-for-elementor' ),
		     	'description'	=> __( 'Slider content is a template which you can choose from Elementor library. Each template will be a slider content', 'pixerex-addons-for-elementor' ),
		...
		$this->add_control('pixerex_carousel_slider_type',
			[
				...
				'description'	=> __( 'Set a navigation type', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SELECT,
				'options'		=> [
        ...
        $this->add_control('pixerex_carousel_dot_navigation_show',
			[
				...
				'description'	=> __( 'Enable or disable navigation dots', 'pixerex-addons-for-elementor' ),
        ...
        $this->add_control('pixerex_carousel_dot_position',
			[
				...
				'default'		=> 'below',
				'options'		=> [
					'below'         => __( 'Below Slides', 'pixerex-addons-for-elementor' ),
					'above'         => __( 'On Slides', 'pixerex-addons-for-elementor' )
				],
                'condition'     => [
        ...
        $this->add_responsive_control('pixerex_carousel_dot_voffset',
			[
                ...
                'selectors'         => [
                    ...
                    '{{WRAPPER}} .pixerex-carousel-dots-below ul.slick-dots' => 'bottom: {{SIZE}}{{UNIT}}',
                ],
                'condition'     => [
                    'pixerex_carousel_dot_navigation_show'  => 'yes',
                ]
        ...
        $this->add_control('pixerex_carousel_navigation_effect',
			[
				'label' 		=> __( 'Ripple Effect', 'pixerex-addons-for-elementor' ),
				'description'	=> __( 'Enable a ripple effect when the active dot is hovered/clicked', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
        ...
        $this->add_control('pixerex_carousel_navigation_show',
			[
				'label'			=> __( 'Arrows', 'pixerex-addons-for-elementor' ),
				'description'	=> __( 'Enable or disable navigation arrows', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
                'separator'     => 'before',
				'default'		=> 'yes'
			]
		...
		$this->add_control('pixerex_carousel_slides_to_show',
			[
				'label'			=> __( 'Appearance', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> 'all',
                'separator'     => 'before',
				'options'		=> [
					'all'			=> __( 'All visible', 'pixerex-addons-for-elementor' ),
					'single'		=> __( 'One at a time', 'pixerex-addons-for-elementor' )
				]
			]
		);
		...
		$this->add_control('pixerex_carousel_responsive_desktop',
			[
				'label'			=> __( 'Desktop Slides', 'pixerex-addons-for-elementor' ),
		...
		$this->add_control('pixerex_carousel_responsive_tabs',
			[
				'label'			=> __( 'Tabs Slides', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::NUMBER,
				'default'		=> 1
			]
		);
		...
		$this->add_control('pixerex_carousel_responsive_mobile',
			[
				'label'			=> __( 'Mobile Slides', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::NUMBER,
				'default'		=> 1
			]
		);
        ...
        $this->start_controls_section('pixerex_carousel_slides_settings',
			[
				'label' => __( 'Slides Settings' , 'pixerex-addons-for-elementor' )
			]
		);
        
		$this->add_control('pixerex_carousel_loop',
			[
				'label'			=> __( 'Infinite Loop', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
                'description'   => __( 'Restart the slider automatically as it passes the last slide', 'pixerex-addons-for-elementor' ),
				'default'		=> 'yes'
			]
		);
		...
		$this->add_control('pixerex_carousel_fade',
			[
				...
				'type'			=> Controls_Manager::SWITCHER,
                'description'   => __( 'Enable fade transition between slides', 'pixerex-addons-for-elementor' ),
                'condition'     => [
		...
		$this->add_control('pixerex_carousel_zoom',
			[
				'label'			=> __( 'Zoom Effect', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
				'condition'		=> [
		...
		$this->add_control('pixerex_carousel_speed',
			[
				'label'			=> __( 'Transition Speed', 'pixerex-addons-for-elementor' ),
				'description'	=> __( 'Set a navigation speed value. The value will be counted in milliseconds (ms)', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::NUMBER,
				'default'		=> 300
			]
		);
		...
		$this->add_control('pixerex_carousel_autoplay',
			[
				'label'			=> __( 'Autoplay Slides‏', 'pixerex-addons-for-elementor' ),
				'description'	=> __( 'Slide will start automatically', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
				'default'		=> 'yes'
			]
		);
		...
		$this->add_control('pixerex_carousel_extra_class',
			[
				'label'			=> __( 'Extra Class', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::TEXT,
                'description'	=> __( 'Add extra class name that will be applied to the carousel, and you can use this class for your customizations.', 'pixerex-addons-for-elementor' ),
			]
		);
		...
		$this->add_control('pixerex_carousel_draggable_effect',
			[
				'label' 		=> __( 'Draggable Effect', 'pixerex-addons-for-elementor' ),
				'description'	=> __( 'Allow the slides to be dragged by mouse click', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
				'default'		=> 'yes'
			]
		);
		...
		$this->add_control('pixerex_carousel_touch_move',
			[
				'label' 		=> __( 'Touch Move', 'pixerex-addons-for-elementor' ),
				'description'	=> __( 'Enable slide moving with touch', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
				'default'		=> 'yes'
			]
		);
		...
		$this->add_control('pixerex_carousel_RTL_Mode',
			[
				...
				'description'	=> __( 'Turn on RTL mode if your language starts from right to left', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
				'condition'		=> [
		...
		$this->add_control('pixerex_carousel_adaptive_height',
			[
				'label' 		=> __( 'Adaptive Height', 'pixerex-addons-for-elementor' ),
				'description'	=> __( 'Adaptive height setting gives each slide a fixed height to avoid huge white space gaps', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control('pixerex_carousel_pausehover',
			[
				...
				'description'	=> __( 'Pause the slider when mouse hover', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control('pixerex_carousel_center_mode',
			[
				...
				'description'	=> __( 'Center mode enables a centered view with partial next/previous slides. Animations and all visible scroll type doesn\'t work with this mode', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
			]
		);
        ...
        $this->add_control('pixerex_carousel_tablet_breakpoint',
			[
				'label' 		=> __( 'Tablet Breakpoint', 'pixerex-addons-for-elementor' ),
                'description'   => __('Sets the breakpoint between desktop and tablet devices. Below this breakpoint tablet layout will appear (Default: 1025px).', 'pixerex-addons-for-elementor'),
				'type'			=> Controls_Manager::NUMBER,
				'default'		=> 1025
			]
		);
        ...
        $this->add_control('pixerex_carousel_mobile_breakpoint',
			[
				'label' 		=> __( 'Mobile Breakpoint', 'pixerex-addons-for-elementor' ),
                'description'   => __('Sets the breakpoint between tablet and mobile devices. Below this breakpoint mobile layout will appear (Default: 768px).', 'pixerex-addons-for-elementor'),
				'type'			=> Controls_Manager::NUMBER,
				'default'		=> 768
			]
		);
        ...
        $this->add_control('pixerex_carousel_arrow_icon_next',
		    [
		        'label'         => __( 'Right Icon', 'pixerex-addons-for-elementor' ),
		...
		$this->add_control('pixerex_carousel_arrow_icon_next_ver',
		    [
		        'label' 	=> __( 'Bottom Icon', 'pixerex-addons-for-elementor' ),
		        'type' 		=> Controls_Manager::CHOOSE,
		        'options' 	=> [
		            'right_arrow_bold'    		=> [
		...
		$this->add_control('pixerex_carousel_arrow_icon_prev_ver',
		    [
		        'label'         => __( 'Top Icon', 'pixerex-addons-for-elementor' ),
		        'type'          => Controls_Manager::CHOOSE,
		        'options'       => [
		            'left_arrow_bold'    		=> [
		...
		$this->add_control('pixerex_carousel_arrow_icon_prev',
		    [
		        'label'         => __( 'Left Icon', 'pixerex-addons-for-elementor' ),
		        'type'          => Controls_Manager::CHOOSE,
		        'options'       => [
		            'left_arrow_bold'    		=> [
        ...
        $this->add_responsive_control('pixerex_carousel_arrow_position',
            [
                'label'         => __('Position (PX)', 'pixerex-addons-for-elementor'),
                'type'          => Controls_Manager::SLIDER,
                'range'         => [
                    'px'    => [
                        'min'       => -100, 
        ...
        $this->add_control('pixerex_carousel_ripple_active_color',
			[
				'label' 		=> __( 'Active Ripple Color', 'pixerex-addons-for-elementor' ),
				'type' 			=> Controls_Manager::COLOR,
				'condition'		=> [
					'pixerex_carousel_dot_navigation_show' => 'yes',
        ...
        $this->add_control('pixerex_carousel_ripple_color',
			[
				'label' 		=> __( 'Inactive Ripple Color', 'pixerex-addons-for-elementor' ),
				'type' 			=> Controls_Manager::COLOR,
				'condition'		=> [
					'pixerex_carousel_dot_navigation_show' => 'yes',
                    'pixerex_carousel_navigation_effect'   => 'yes'
