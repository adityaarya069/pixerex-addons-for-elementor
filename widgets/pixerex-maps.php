...
class Pixerex_Maps extends Widget_Base {
    ...
    public function get_title() {
		return sprintf( '%1$s %2$s', Helper_Functions::get_prefix(), __('Google Maps', 'pixerex-addons-for-elementor') );
	}
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section('pixerex_maps_map_settings',
                [
                    'label'         => __('Center Location', 'pixerex-addons-for-elementor'),
                    ]
                );
        ...
        $this->add_control('pixerex_map_ip_location',
            [
                'label'         => __( 'Get User Location', 'pixerex-addons-for-elementor' ),
                'description'   => __('Get center location from visitor\'s location','pixerex-addons-for-elementor'),
        ...
        $this->add_control('pixerex_map_location_finder',
            [
                'label'         => __( 'Latitude & Longitude Finder', 'pixerex-addons-for-elementor' ),
                'type'          => Controls_Manager::SWITCHER,
                'condition'     => [
        ...
        $this->add_control('pixerex_maps_center_lat',
                [
                    'label'         => __('Center Latitude', 'pixerex-addons-for-elementor'),
                    'type'          => Controls_Manager::TEXT,
                    'dynamic'       => [ 'active' => true ],
                    'description'   => __('Center latitude and longitude are required to identify your location', 'pixerex-addons-for-elementor'),
                    'default'       => '18.591212',
                    'label_block'   => true,
                    'condition'     => [
                        'pixerex_map_ip_location!'  => 'true'
        ...
        $this->add_control('pixerex_maps_center_long',
                [
                    'label'         => __('Center Longitude', 'pixerex-addons-for-elementor'),
                    'type'          => Controls_Manager::TEXT,
                    'dynamic'       => [ 'active' => true ],
                    'description'   => __('Center latitude and longitude are required to identify your location', 'pixerex-addons-for-elementor'),
                    'default'       => '73.741261',
        ...
        $this->start_controls_section('pixerex_maps_map_pins_settings',
            [
                'label'         => __('Markers', 'pixerex-addons-for-elementor'),
            ]
        );
        
        $this->add_control('pixerex_maps_markers_width',
                [
                    'label'         => __('Max Width', 'pixerex-addons-for-elementor'),
                    'type'          => Controls_Manager::NUMBER,
                    'title'         => __('Set the Maximum width for markers description box','pixerex-addons-for-elementor'),
                    ]
                );
        ...
        $repeater->add_control('pin_icon',
            [
                'label'         => __('Custom Icon', 'pixerex-addons-for-elementor'),
        ...
        $repeater->add_control('map_latitude',
            [
                'label'         => __('Latitude', 'pixerex-addons-for-elementor'),
                'type'          => Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
        ...
        $repeater->add_control('map_longitude',
            [
                'name'          => 'map_longitude',
                'label'         => __('Longitude', 'pixerex-addons-for-elementor'),
                'type'          => Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
                'description'   => 'Click <a href="https://www.latlong.net/" target="_blank">here</a> to get your location coordinates',
                'label_block'   => true,
        ...
        $this->add_control('pixerex_maps_map_pins',
            [
                'label'         => __('Map Pins', 'pixerex-addons-for-elementor'),
                'type'          => Controls_Manager::REPEATER,
                'default'       => [
                    'map_latitude'      => '18.591212',
                    'map_longitude'     => '73.741261',
                    'pin_title'         => __('Pixerex Google Maps', 'pixerex-addons-for-elementor'),
                    'pin_desc'          => __('Add an optional description to your map pin', 'pixerex-addons-for-elementor'),
                ],
        ...
        $this->add_control('pixerex_maps_map_type',
                [
                    'label'         => __( 'Map Type', 'pixerex-addons-for-elementor' ),
                    'type'          => Controls_Manager::SELECT,
                    'options'       => [
                        'roadmap'       => __( 'Road Map', 'pixerex-addons-for-elementor' ),
                        'satellite'     => __( 'Satellite', 'pixerex-addons-for-elementor' ),
                        'terrain'       => __( 'Terrain', 'pixerex-addons-for-elementor' ),
                        'hybrid'        => __( 'Hybrid', 'pixerex-addons-for-elementor' ),
                        ],
                    'default'       => 'roadmap',
                    ]
                );
        ...
        $this->add_control('pixerex_maps_map_zoom',
                [
                    'label'         => __( 'Zoom', 'pixerex-addons-for-elementor' ),
                    'type'          => Controls_Manager::SLIDER,
                    'default'       => [
                        'size' => 12,
                    ],
        ...
        $this->add_control('pixerex_maps_map_option_map_type_control',
                [
                    'label'         => __( 'Map Type Controls', 'pixerex-addons-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                ]
                );
        ...
        $this->add_control('pixerex_maps_map_option_zoom_controls',
                [
                    'label'         => __( 'Zoom Controls', 'pixerex-addons-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                ]
                );
        ...
        $this->add_control('pixerex_maps_map_option_streeview',
                [
                    'label'         => __( 'Street View Control', 'pixerex-addons-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                ]
                );
        ...
        $this->add_control('pixerex_maps_map_option_fullscreen_control',
                [
                    'label'         => __( 'Fullscreen Control', 'pixerex-addons-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                ]
                );
        ...
        $this->add_control('pixerex_maps_map_option_mapscroll',
                [
                    'label'         => __( 'Scroll Wheel Zoom', 'pixerex-addons-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                ]
                );
        ...
        $this->add_control('pixerex_maps_marker_open',
                [
                    'label'         => __( 'Info Container Always Opened', 'pixerex-addons-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                ]
                );
        ...
        $this->add_control('pixerex_maps_marker_hover_open',
                [
                    'label'         => __( 'Info Container Opened when Hovered', 'pixerex-addons-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                ]
                );
        ...
        $this->add_control('pixerex_maps_marker_mouse_out',
                [
                    'label'         => __( 'Info Container Closed when Mouse Out', 'pixerex-addons-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'condition'     => [
        ...
        if( $settings['pixerex-map-cluster'] ) {
            $this->add_control('pixerex_maps_map_option_cluster',
                [
                    'label'         => __( 'Marker Clustering', 'pixerex-addons-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                ]
            );
        }
        ...
        $this->start_controls_section('pixerex_maps_custom_styling_section',
            [
                'label'         => __('Map Style', 'pixerex-addons-for-elementor'),
            ]
        );
        
        $this->add_control('pixerex_maps_custom_styling',
            [
                'label'         => __('JSON Code', 'pixerex-addons-for-elementor'),
        ...
        $this->start_controls_section('pixerex_maps_box_style',
                [
                    'label'         => __('Map', 'pixerex-addons-for-elementor'),
                    'tab'           => Controls_Manager::TAB_STYLE,
                ]
                );
