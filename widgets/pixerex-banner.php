...
class Pixerex_Banner extends Widget_Base {
	...
	public function get_name() {
		return 'pixerex-addon-banner';
	}

	public function get_title() {
		return sprintf( '%1$s %2$s', Helper_Functions::get_prefix(), __('Banner', 'pixerex-addons-for-elementor') );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control('pixerex_banner_image',
			[
				...
				'description'	=> __( 'Select an image for the Banner', 'pixerex-addons-for-elementor' ),
		...
		$this->add_control('pixerex_banner_image_link_switcher',
			[
				'label'			=> __( 'Custom Link', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
				'description'	=> __( 'Add a custom link to the banner', 'pixerex-addons-for-elementor' ),
                'condition'     => [
        ...
        $this->add_control('pixerex_banner_image_custom_link',
			[
				'label'			=> __( 'Set custom Link', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::URL,
                'dynamic'       => [ 'active' => true ],
				'description'	=> __( 'What custom link you want to set to banner?', 'pixerex-addons-for-elementor' ),
				'condition'		=> [
		...
		$this->add_control('pixerex_banner_image_link_open_new_tab',
			[
				'label'			=> __( 'New Tab', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
				'description'	=> __( 'Choose if you want the link be opened in a new tab or not', 'pixerex-addons-for-elementor' ),
                'condition'     => [
                    'pixerex_banner_link_url_switch'    => 'yes'
                ]
			]
		...
		$this->add_control('pixerex_banner_image_link_add_nofollow',
			[
				'label'			=> __( 'Nofollow Option', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
				'description'	=> __('if you choose yes, the link will not be counted in search engines', 'pixerex-addons-for-elementor' ),
                'condition'     => [
                    'pixerex_banner_link_url_switch'    => 'yes'
                ]
			]
        ...
        $this->add_control('pixerex_banner_image_animation',
			[
				...
				'default'		=> 'animation1',
				'description'	=> __( 'Choose a hover effect for the banner', 'pixerex-addons-for-elementor' ),
				'options'		=> [
					'animation1'		=> __('Effect 1', 'pixerex-addons-for-elementor'),
					'animation5'		=> __('Effect 2', 'pixerex-addons-for-elementor'),
					'animation13'       => __('Effect 3', 'pixerex-addons-for-elementor'),
					'animation2'		=> __('Effect 4', 'pixerex-addons-for-elementor'),
					'animation4'		=> __('Effect 5', 'pixerex-addons-for-elementor'),
					'animation6'		=> __('Effect 6', 'pixerex-addons-for-elementor')
				]
			]
		);
        ...
        $this->add_control('pixerex_banner_active',
			[
				'label'			=> __( 'Always Hovered', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SWITCHER,
				'description'	=> __( 'Choose if you want the effect to be always triggered', 'pixerex-addons-for-elementor' )
			]
		);
        ...
        $this->add_control('pixerex_banner_height',
			[
				...
				'type'			=> Controls_Manager::SELECT,
                'options'		=> [
					'default'		=> __('Default', 'pixerex-addons-for-elementor'),
					'custom'		=> __('Custom', 'pixerex-addons-for-elementor')
				],
				'default'		=> 'default',
				'description'	=> __( 'Choose if you want to set a custom height for the banner or keep it as it is', 'pixerex-addons-for-elementor' )
			]
		);
        
		$this->add_responsive_control('pixerex_banner_custom_height',
			[
				'label'			=> __( 'Min Height', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::NUMBER,
				'description'	=> __( 'Set a minimum height value in pixels', 'pixerex-addons-for-elementor' ),
				'condition'		=> [
        ...
        $this->add_responsive_control('pixerex_banner_img_vertical_align',
			[
                ...
                'options'		=> [
					'flex-start'	=> __('Top', 'pixerex-addons-for-elementor'),
                    'center'		=> __('Middle', 'pixerex-addons-for-elementor'),
					'flex-end'		=> __('Bottom', 'pixerex-addons-for-elementor'),
                    'inherit'		=> __('Full', 'pixerex-addons-for-elementor')
				],
                'default'       => 'flex-start',
				'selectors'		=> [
        ...
        $this->add_control('mouse_tilt',
            [
                'label'         => __('Enable Mouse Tilt', 'pixerex-addons-for-elementor'),
                'type'          => Controls_Manager::SWITCHER,
                'return_value'  => 'true'
            ]
        );
		...
		$this->add_control('pixerex_banner_extra_class',
			[
				...
				'type'			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
                'description'	=> __( 'Add extra class name that will be applied to the banner, and you can use this class for your customizations.', 'pixerex-addons-for-elementor' )
			]
		);
        ...
        $this->add_control('pixerex_banner_title',
			[
				...
				'placeholder'	=> __( 'Give a title to this banner', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
				'default'		=> __( 'Pixerex Banner', 'pixerex-addons-for-elementor' ),
				'label_block'	=> false
			]
		);
        ...
        $this->add_control('pixerex_banner_title_tag',
			[
				...
				'description'	=> __( 'Select a heading tag for the title. Headings are defined with H1 to H6 tags', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> 'h3',
				'options'       => [
                    'h1'    => 'H1',
        ...
        $this->add_control('pixerex_banner_description',
			[
				'label'			=> __( 'Description', 'pixerex-addons-for-elementor' ),
				'description'	=> __( 'Give the description to this banner', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::WYSIWYG,
                'dynamic'       => [ 'active' => true ],
				'default'		=> __( 'Pixerex Banner gives you a wide range of styles and options that you will definitely fall in love with', 'pixerex-addons-for-elementor' ),
				'label_block'	=> true
			]
		);
        ...
        $this->add_control('pixerex_banner_responsive_switcher',
            [
                ...
                'type'          => Controls_Manager::SWITCHER,
                'description'   => __('If the description text is not suiting well on specific screen sizes, you may enable this option which will hide the description text.', 'pixerex-addons-for-elementor')
            ]
        );
		...
		$this->add_control('pixerex_banner_image_opacity',
			[
				'label' => __( 'Image Opacity', 'pixerex-addons-for-elementor' ),
		...
		$this->add_control('pixerex_banner_image_hover_opacity',
			[
				'label' => __( 'Hover Opacity', 'pixerex-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1
				],
        ...
        $this->add_control('pixerex_banner_style2_title_bg',
			[
				'label'			=> __( 'Background', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::COLOR,
				'default'       => '#f2f2f2',
				'description'	=> __( 'Choose a background color for the title', 'pixerex-addons-for-elementor' ),
				'condition'		=> [
		...
		$this->add_control('pixerex_banner_style3_title_border',
			[
				'label'			=> __( 'Title Border Color', 'pixerex-addons-for-elementor' ),
				'type'			=> Controls_Manager::COLOR,
				'condition'		=> [
		...
		$this->add_control('pixerex_banner_scaled_border_color',
			[
				'label' => __( 'Inner Border Color', 'pixerex-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'condition'		=> [
	...
	protected function render() {
            ...
            $this->add_render_attribute( 'banner', 'id', 'pixerex-banner-' . $this->get_id() );
            $this->add_render_attribute( 'banner', 'class', 'pixerex-banner' );
				...
				<div class="pixerex-banner-ib <?php echo $full_class; ?> pixerex-banner-min-height">
                    ...
                    if( 'yes' == $settings['pixerex_banner_link_switcher'] && !empty( $settings['pixerex_banner_more_text'] ) ) : ?>
                            ...
                            <div class ="pixerex-banner-read-more">
                                <a class = "pixerex-banner-link" <?php if( !empty( $banner_url ) ) : ?> href="<?php echo $banner_url; ?>"<?php endif;?><?php if( !empty( $settings['pixerex_banner_link']['is_external'] ) ) : ?> target="_blank" <?php endif; ?><?php if( !empty($settings['pixerex_banner_link']['nofollow'] ) ) : ?> rel="nofollow" <?php endif; ?>><?php echo esc_html( $settings['pixerex_banner_more_text'] ); ?></a>
                            </div>
