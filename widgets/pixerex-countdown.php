...
class Pixerex_Countdown extends Widget_Base {
	...
	public function get_title() {
        return sprintf( '%1$s %2$s', Helper_Functions::get_prefix(), __('Countdown', 'pixerex-addons-for-elementor') );
	}
    ...
    // Adding the controls fields for the pixerex countdown
    // This will controls the animation, colors and background, dimensions etc
	protected function _register_controls() {
		$this->start_controls_section(
			'pixerex_countdown_global_settings',
			[
				'label'		=> __( 'Countdown', 'pixerex-addons-for-elementor' )
			]
		);
		...
		$this->add_control(
			'pixerex_countdown_style',
		  	[
		     	...
		     	'options' 		=> [
		     		'd-u-s' => __( 'Inline', 'pixerex-addons-for-elementor' ),
		     		'd-u-u' => __( 'Block', 'pixerex-addons-for-elementor' ),
		     	],
		     	'default'		=> 'd-u-u'
		  	]
		);
		...
		$this->add_control(
			'pixerex_countdown_date_time',
		  	[
		     	'label'			=> __( 'Due Date', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::DATE_TIME,
		     	'picker_options'	=> [
		     		'format' => 'Ym/d H:m:s'
		     	],
		     	'default' => date( "Y/m/d H:m:s", strtotime("+ 1 Day") ),
				'description' => __( 'Date format is (yyyy/mm/dd). Time format is (hh:mm:ss). Example: 2020-01-01 09:30.', 'pixerex-addons-for-elementor' )
		  	]
		);
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'Time Zone', 'pixerex-addons-for-elementor' ),
				'type' 			=> Controls_Manager::SELECT,
				'options' 		=> [
					'wp-time'			=> __('WordPress Default', 'pixerex-addons-for-elementor' ),
					'user-time'			=> __('User Local Time', 'pixerex-addons-for-elementor' )
				],
				'default'		=> 'wp-time',
				'description'	=> __('This will set the current time of the option that you will choose.', 'pixerex-addons-for-elementor')
			]
		);
		...
		$this->add_control(
			'pixerex_countdown_units',
		  	[
		     	'label'			=> __( 'Time Units', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::SELECT2,
				'description' => __('Select the time units that you want to display in countdown timer.', 'pixerex-addons-for-elementor' ),
				'options'		=> [
					'Y'     => __( 'Years', 'pixerex-addons-for-elementor' ),
					'O'     => __( 'Month', 'pixerex-addons-for-elementor' ),
					'W'     => __( 'Week', 'pixerex-addons-for-elementor' ),
					'D'     => __( 'Day', 'pixerex-addons-for-elementor' ),
					'H'     => __( 'Hours', 'pixerex-addons-for-elementor' ),
					'M'     => __( 'Minutes', 'pixerex-addons-for-elementor' ),
					'S' 	=> __( 'Second', 'pixerex-addons-for-elementor' ),
				],
				'default' 		=> [ 'O', 'D', 'H', 'M', 'S' ],
				'multiple'		=> true,
				'separator'		=> 'after'
        ...
        $this->add_control('pixerex_countdown_separator',
            [
                'label'         => __('Digits Separator', 'pixerex-addons-for-elementor'),
                'description'   => __('Enable or disable digits separator','pixerex-addons-for-elementor'),
        ...
        $this->add_control(
			...
			[
				'label'			=> __('Separator Text', 'pixerex-addons-for-elementor'),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Expire' , 'pixerex-addons-for-elementor' )
			]
		);
		...
		$this->add_control(
			...
			[
				'label'			=> __('Expire Type', 'pixerex-addons-for-elementor'),
				'label_block'	=> false,
				'type'			=> Controls_Manager::SELECT,
                'description'   => __('Choose whether if you want to set a message or a redirect link', 'pixerex-addons-for-elementor'),
				'options'		=> [
					'text'		=> __('Message', 'pixerex-addons-for-elementor'),
					'url'		=> __('Redirection Link', 'pixerex-addons-for-elementor')
				],
				'default'		=> 'text'
			]
		);
		...
		$this->add_control(
			...
			[
				'label'			=> __('On expiry Text', 'pixerex-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				'label'			=> __('Redirect To', 'pixerex-addons-for-elementor'),
				'type'			=> Controls_Manager::TEXT,
                'dynamic'       => [
                    'active' => true,
                    'categories' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Strings Translation' , 'pixerex-addons-for-elementor' )
			]
		);
		...
		$this->add_control(
			'pixerex_countdown_day_singular',
		  	[
		     	'label'			=> __( 'Day (Singular)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Day'
		  	]
		...
		$this->add_control(
			'pixerex_countdown_day_plural',
		  	[
		     	'label'			=> __( 'Day (Plural)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Days'
		  	]
		...
		$this->add_control(
			'pixerex_countdown_week_singular',
		  	[
		     	'label'			=> __( 'Week (Singular)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Week'
		  	]
		...
		$this->add_control(
			'pixerex_countdown_week_plural',
		  	[
		     	'label'			=> __( 'Weeks (Plural)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Weeks'
		  	]
		...
		$this->add_control(
			'pixerex_countdown_month_singular',
		  	[
		     	'label'			=> __( 'Month (Singular)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Month'
		  	]
		...
		$this->add_control(
			'pixerex_countdown_month_plural',
		  	[
		     	'label'			=> __( 'Months (Plural)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Months'
		  	]
		...
		$this->add_control(
			'pixerex_countdown_year_singular',
		  	[
		     	'label'			=> __( 'Year (Singular)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Year'
		  	]
		...
		$this->add_control(
			'pixerex_countdown_year_plural',
		  	[
		     	'label'			=> __( 'Years (Plural)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Years'
		  	]
		...
		$this->add_control(
			'pixerex_countdown_hour_singular',
		  	[
		     	'label'			=> __( 'Hour (Singular)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Hour'
		  	]
		...
		$this->add_control(
			'pixerex_countdown_hour_plural',
		  	[
		     	'label'			=> __( 'Hours (Plural)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Hours'
		  	]
		...
		$this->add_control(
			'pixerex_countdown_minute_singular',
		  	[
		     	'label'			=> __( 'Minute (Singular)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Minute'
		  	]
		...
		$this->add_control(
			'pixerex_countdown_minute_plural',
		  	[
		     	'label'			=> __( 'Minutes (Plural)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Minutes'
		  	]
        ...
        $this->add_control(
			'pixerex_countdown_second_singular',
		  	[
		     	'label'			=> __( 'Second (Singular)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Second',
		  	]
		...
		$this->add_control(
			'pixerex_countdown_second_plural',
		  	[
		     	'label'			=> __( 'Seconds (Plural)', 'pixerex-addons-for-elementor' ),
		     	'type' 			=> Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
		     	'default'		=> 'Seconds'
		  	]
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Digits' , 'pixerex-addons-for-elementor' ),
        ...
        $this->start_controls_section('pixerex_countdown_unit_style', 
            [
                'label'         => __('Units', 'pixerex-addons-for-elementor'),
                'tab'           => Controls_Manager::TAB_STYLE,
            ]
            );
        ...
        $this->add_responsive_control(
			...
			[
				'label'			=> __( 'Spacing in Between', 'pixerex-addons-for-elementor' ),
				'type' 			=> Controls_Manager::SLIDER,
				'default' 		=> [
					'size' => 40,
				],
